  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mt-8 bg-white rounded-xl shadow-md p-6">
        <h2 className="text-xl font-bold text-primary-700 mb-4">How to Earn Karma</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-primary-50 p-4 rounded-lg">
            <div className="w-12 h-12 bg-primary-600 text-white rounded-full flex items-center justify-center mb-3">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
              </svg>
            </div>
            <h3 className="font-bold text-primary-700 mb-1">Answer Requests</h3>
          ...
          <div className="bg-primary-50 p-4 rounded-lg">
            ...
            <h3 className="font-bold text-primary-700 mb-1">Be Consistent</h3>
            <p className="text-sm text-neutral-600">
          ...
          <div className="bg-primary-50 p-4 rounded-lg">
            ...
            <h3 className="font-bold text-primary-700 mb-1">Quality Contributions</h3>
            <p className="text-sm text-neutral-600">
